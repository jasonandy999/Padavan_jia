...
struct nvram_pair router_defaults[] = {
	...
	{ "trojan_link", "https://cdn.jsdelivr.net/gh/jasonandy999/Padavan_jia/ssp/trojan" },
	{ "v2_local_enable", "0" },
	{ "v2_local", "/tmp/v2ray" },
	{ "v2_link", "https://cdn.jsdelivr.net/gh/jasonandy999/Padavan_jia/ssp/v2ray" },
	{ "ss_mode", "1" },
	{ "ss_server", "127.0.0.1" },
	{ "ss_server_port", "8989" },
	{ "ss_key", "Secret" },
	...
	{ "adg_enable", "0" },
	{ "adg_redirect", "0" },
	{ "adg_link", "https://cdn.jsdelivr.net/gh/jasonandy999/Padavan_jia/adg/AdGuardHome" },
#endif
